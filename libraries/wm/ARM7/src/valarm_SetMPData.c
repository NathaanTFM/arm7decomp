...
void WMSP_VAlarmSetMPData()
{ // valarm_SetMPData.c:29
...
void WMSP_KickNextMP_Parent(void *msg)
{                             // valarm_SetMPData.c:173
...
void WMSP_KickNextMP_Child()
{ // valarm_SetMPData.c:201
...
void WMSP_KickNextMP_Resume(void *msg)
{                             // valarm_SetMPData.c:230
