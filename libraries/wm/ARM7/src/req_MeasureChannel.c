...
void WMSP_MeasureChannel(void *msg)
{                                       // req_MeasureChannel.c:36
    ...
    WMMeasureChannelCallback *callback; // r0 - :56
    ...
    if (0)
    {
        ...
        WMMeasureChannelReq *args;    // r0 - :124
        u16 cb_channel;               // r5 - :148
        u16 cb_ccaBusyRatio;          // r6 - :149
        WMMeasureChannelCallback *cb; // r0 - :150
    }
    if (0)
    {
