...
WlMlmePowerMgtCfm *WMSP_WL_MlmePowerManagement(u16 *buf, u16 pwrMgtMode, u16 wakeUp, u16 recieveDtims)
{                           // wmsp_wl_control.c:85
...
WlMlmeAuthCfm *WMSP_WL_MlmeAuthenticate(u16 *buf, u16 *peerMacAdrs, u16 algorithm, u16 timeOut)
{                       // wmsp_wl_control.c:223
...
WlMaClrDataCfm *WMSP_WL_MaClearData(u16 *buf, u16 flag)
{                        // wmsp_wl_control.c:712
