...
static const u16 def_SsidMask[16] = {
    0,
    0,
    0,
    0,
...
{                                // WlNic.c:2602
    ...
    {                                                 // :2619
        ...
        if (brate < 0x78 && RateElement2Bit[brate] != 0xFF)
        {                                                       // :2625
...
{ // WlNic.c:4609
    static const u16 crc16_table[16] = {
        ...
        0xA001, 0x6C00, 0x7800, 0xB401, 0x5000, 0x9C01, 0x8801, 0x4400}; // :4580
    u16 r1;                                                              // r0 - :4611
